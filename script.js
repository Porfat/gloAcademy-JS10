...
let mandatoryExp1 = prompt('1. Какие обязательные ежемесячные расходы у вас есть?'),
mandatoryExp1Cost = prompt('1. Во сколько это обойдется?'),
mandatoryExp2 = prompt('2. Какие обязательные ежемесячные расходы у вас есть?'),
mandatoryExp2Cost = prompt('2. Во сколько это обойдется?'),
